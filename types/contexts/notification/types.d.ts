...
export declare type NotificationActionTypes = 'ADD_BOTTOM_NOTIFICATION' | 'ADD_BOTTOM_LEFT_NOTIFICATION' | 'ADD_BOTTOM_RIGHT_NOTIFICATION' | 'ADD_TOP_NOTIFICATION' | 'ADD_TOP_LEFT_NOTIFICATION' | 'ADD_TOP_RIGHT_NOTIFICATION' | 'REMOVE_BOTTOM_NOTIFICATION' | 'REMOVE_BOTTOM_LEFT_NOTIFICATION' | 'REMOVE_BOTTOM_RIGHT_NOTIFICATION' | 'REMOVE_TOP_NOTIFICATION' | 'REMOVE_TOP_LEFT_NOTIFICATION' | 'REMOVE_TOP_RIGHT_NOTIFICATION';
