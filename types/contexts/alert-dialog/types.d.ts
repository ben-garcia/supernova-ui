...
export interface AlertDialogContextProps {
  ...
  getAlertDialogBodyProps?: (props: Omit<AlertDialogBodyProps, 'children'>) =>
    FC<Omit<AlertDialogBodyProps, 'children'>>;
  getAlertDialogHeaderProps?: (props: Omit<AlertDialogHeaderProps, 'children'>) =>
    FC<Omit<AlertDialogHeaderProps, 'children'>>;
  getAlertDialogFooterProps?: (props: Omit<AlertDialogFooterProps, 'children'>) =>
