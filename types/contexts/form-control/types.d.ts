...
export interface FormControl extends Omit<FormControlProps, 'children' | 'id' | 'tag'> {
  getErrorMessageProps: (props: FormHelperTextProps, ref: ForwardedRef<HTMLDivElement>) =>
    FC<Omit<FormHelperTextProps, 'children'>>;
  getHelpTextProps: (props: FormHelperTextProps, ref: ForwardedRef<HTMLDivElement>) =>
    FC<Omit<FormHelperTextProps, 'children'>>;
