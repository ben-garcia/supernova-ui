...
/**
 * React hooks that combines related props for use in other hooks.
 *
 * @param 'props' component props.
 */
export const useValidateProps = (props: any) => {
  const cssProps: AnyObject = {};
  const pseudoClassProps: AnyObject = {};
